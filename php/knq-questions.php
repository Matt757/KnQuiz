...
function insertDefaultCategories() {
    ...
    $codform .= "<li id='category1' class='category'><label for='categoryName1'>Category Name:</label><br><input type='text' id='categoryName1' name='categoryName1' class='categoryName' value='Category 1'><br><label for='category1Elements'>Elements belonging to the category:</label><br><input size='80' type='text' id='category1Elements' name='category1Elements' class='categoryElements' value='element 1, element 2'><button type=button class='button button-secondary' style='background-color: #dc3545; border-color: #dc3545; color: white; margin-left: 0.5vw; margin-right: 0.5vw;' onclick='deleteAnswer(1, 15)' class='button button-primary'><i class='fa fa-minus-circle' aria-hidden='true'></i></button></li>";
    $codform .= "<li id='category2' class='category'><label for='categoryName2'>Category Name:</label><br><input type='text' id='categoryName2' name='categoryName2' class='categoryName' value='Category 2'><br><label for='category2Elements'>Elements belonging to the category:</label><br><input size='80' type='text' id='category2Elements' name='category2Elements' class='categoryElements' value='element 1, element 2'><button type=button class='button button-secondary' style='background-color: #dc3545; border-color: #dc3545; color: white; margin-left: 0.5vw; margin-right: 0.5vw;' onclick='deleteAnswer(2, 15)' class='button button-primary'><i class='fa fa-minus-circle' aria-hidden='true'></i></button></li>";
    $codform .= "</ul>";
...
function knq_questions()
{
    ...
    if ($detaliiIntrebari[0]->type == 1 || $detaliiIntrebari[0]->type == 2 || $detaliiIntrebari[0]->type == 3 || $detaliiIntrebari[0]->type == 12 || $detaliiIntrebari[0]->type == 9) {
        ...
        for ($i = 0; $i < count($answersArray); $i++) {
            ...
            $counter++;
            $codform .= "<li id='category" . ($i + 1) . "' class='category'><label for='categoryName" . ($i + 1) . "'>Category Name:</label><br><input type='text' id='categoryName" . ($i + 1) . "' name='categoryName" . ($i + 1) . "' class='categoryName' value='" . $categoryArray[0] . "'><br><label for='category" . ($i + 1) . "Elements'>Elements belonging to the category:</label><br><input size='80' type='text' id='category" . ($i + 1) . "Elements' name='category" . ($i + 1) . "Elements' class='categoryElements' value='" . implode(", ", array_slice($categoryArray, 1)) . "'><button type=button class='button button-secondary' style='background-color: #dc3545; border-color: #dc3545; color: white; margin-left: 0.5vw; margin-right: 0.5vw;' onclick='deleteAnswer(" . $counter - 1 . ", " . $detaliiIntrebari[0]->type . ")' class='button button-primary'><i class='fa fa-minus-circle' aria-hidden='true'></i></button></li>";
        }
    ...
    $codform .= '<script type="text/javascript">crossword_match="' . __('Number of questions does not match the number of rows in the crossword', 'knq') . '"; column_limit="' . __('Invalid column', 'knq') . '"; empty_crossword="' . __('No crossword provided', 'knq') . '"; min_1_question="' . __('At least 1 question needed', 'knq') . '"; empty_question="' . __('Empty question', 'knq') . '"; empty_image_answer="' . __('Empty answer', 'knq') . '"; no_pixelated_image="' . __('No image selected', 'knq') . '"; empty_category="' . __('Empty category name', 'knq') . '"; min_2_categories="' . __('At least 2 categories needed.', 'knq') . '"; empty_input="' . __('Empty input', 'knq') .'"; invalid_columns="' . __('Invalid columns', 'knq') .'"; invalid_rows="' . __('Invalid rows', 'knq') . '"; no_image_selected="' . __('No image selected', 'knq') . '"; empty_question="' . __('Empty question', 'knq') .'"; min_2_answers="' . __('At least 2 answers needed', 'knq') . '"; min_2_images="' . __('At least 2 images needed', 'knq') . '"; empty_answer="' . __('Empty answer', 'knq') . '"; no_right_answer="' . __('No right answer selected', 'knq') . '"; too_many_right_answers="' . __('Too many right answers selected', 'knq') .  '"; incorrect_formating = "' . __('Incorrect formatting', 'knq') .'"; width_limit="' . __('Must be between 1 and 100', 'knq') .'"; empty_word_search="' . __('Empty word search', 'knq') . '"; no_search_words="' . __('No search words provided', 'knq') . '"; min_3_search_words="' . __('Provide at least 3 search words', 'knq') . '"</script>';
